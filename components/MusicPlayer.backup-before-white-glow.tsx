    ...
    <>
      ...
      <div className="fixed bottom-5 left-1/2 z-[60] w-[calc(100%-24px)] max-w-[560px] -translate-x-1/2">
        ...
        {playlistOpen && songs.length > 0 && (
          <div className="mb-2 max-h-[300px] overflow-y-auto rounded-[20px] border border-white/[0.11] bg-white/[0.008] p-2 shadow-[0_12px_50px_rgba(0,0,0,0.25)] backdrop-blur-lg">
        ...
        {/* GLASS MUSIC PLAYER */}
        <div className="rounded-[24px] border border-white/[0.035] bg-white/[0.018] px-3 py-3 shadow-[0_0_35px_rgba(255,255,255,0.035)] backdrop-blur-md sm:px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="group flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/[0.07] bg-white/[0.008] text-white/55 shadow-[0_4px_20px_rgba(0,0,0,0.18)] backdrop-blur-md transition-all duration-200 hover:-translate-x-0.5 hover:border-white/[0.14] hover:bg-white/[0.07] hover:text-white active:scale-90 disabled:pointer-events-none disabled:opacity-20"
            ...
            <button
              type="button"
              onClick={() => setPlaylistOpen((prev) => !prev)}
              className="group flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/[0.07] bg-white/[0.008] text-white/50 shadow-[0_4px_20px_rgba(0,0,0,0.18)] backdrop-blur-md transition-all duration-200 hover:scale-105 hover:border-white/[0.14] hover:bg-white/[0.07] hover:text-white active:scale-90"
              aria-label="Toggle playlist"
            >
