    ...
    <>
      ...
      <div className="fixed bottom-5 left-1/2 z-[60] w-[calc(100%-24px)] max-w-[560px] -translate-x-1/2">
        ...
        {playlistOpen && songs.length > 0 && (
          <div className="mb-2 max-h-[300px] overflow-y-auto rounded-[20px] border border-white/[0.11] bg-black/[0.20] p-2 shadow-[0_12px_50px_rgba(0,0,0,0.25)] backdrop-blur-xl">
        ...
        {/* GLASS MUSIC PLAYER */}
        <div className="rounded-[22px] border border-white/[0.08] bg-white/[0.025] px-3 py-3 shadow-[0_12px_50px_rgba(0,0,0,0.20)] backdrop-blur-xl sm:px-4">
          ...
          <div className="mt-1.5 flex items-center justify-between px-1 text-[8px] font-mono tracking-wider text-white/30">
            ...
            <span className="h-px flex-1 mx-2 bg-white/[0.06]" />
